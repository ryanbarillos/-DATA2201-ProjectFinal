...
-- 4. Add Bank Branch
GO
CREATE PROCEDURE Add_BankBranch
...
-- 1. Add_BankBranch
EXEC Add_BankBranch @BankProvince = 'Alberta', @BankCity = 'Calgary', @BankCountry = 'Canada', @BankPostalCode = 'T2E 039', @BankName = 'Calgary Dominion', @BankVaultValue = 5000000.00;
EXEC Add_BankBranch @BankProvince = 'Alberta', @BankCity = 'Red Deer', @BankCountry = 'Canada', @BankPostalCode = 'T2E 040', @BankName = 'Red Deer Dominion', @BankVaultValue = 2500000.00;
EXEC Add_BankBranch @BankProvince = 'Ontario', @BankCity = 'Toronto', @BankCountry = 'Canada', @BankPostalCode = 'M5V 1J2', @BankName = 'Bank of Toronto', @BankVaultValue = 500000.00;
EXEC Add_BankBranch 'California', 'Los Angeles', 'USA', '90001', 'LA Savings Bank', 300000.00;
EXEC Add_BankBranch 'Texas', 'Houston', 'USA', '77002', 'Houston National Bank', 600000.00
EXEC Add_BankBranch 'New York', 'New York', 'USA', '10001', 'NYC Bank', 900000.00;
EXEC Add_BankBranch 'London', 'London', 'UK', 'WC2N 5DU', 'London Bank', 700000.00;
EXEC Add_BankBranch 'Quebec', 'Montreal', 'Canada', 'H2X 1Y6', 'Montreal Savings', 400000.00;
EXEC Add_BankBranch 'Florida', 'Miami', 'USA', '33101', 'Miami National Bank', 450000.00;
EXEC Add_BankBranch 'British Columbia', 'Vancouver', 'Canada', 'V6C 3E2', 'Vancouver Bank', 550000.00;
EXEC Add_BankBranch 'Illinois', 'Chicago', 'USA', '60601', 'Chicago Savings Bank', 350000.00;
EXEC Add_BankBranch 'Alberta', 'Calgary', 'Canada', 'T2P 3H7', 'Calgary Bank', 420000.00;
SELECT *
FROM BankBranch


-- 2. Add_BankManager
EXEC Add_BankManager @MgrName = 'John Doe', @MgrAddress = '123 45 AVE SW', @MgrWorkStarted = '2023-10-24';
EXEC Add_BankManager @MgrName = 'Jane Doe', @MgrAddress = '234 56 AVE SE', @MgrWorkStarted = '2023-10-25';
EXEC Add_BankManager 'John', '123 Main St', '2023-01-15';
EXEC Add_BankManager 'Sarah', '456 Elm Ave', '2023-02-20';
EXEC Add_BankManager 'Michael', '789 Oak Ln', '2023-03-10';
EXEC Add_BankManager 'Emily', '101 Pine Rd', '2023-04-05';
EXEC Add_BankManager 'William', '234 Birch Blvd', '2023-05-12';
EXEC Add_BankManager 'Olivia', '567 Cedar Dr', '2023-06-25';
EXEC Add_BankManager 'James', '890 Redwood St', '2023-07-15';
EXEC Add_BankManager 'Sophia', '111 Spruce Ave', '2023-08-03';
EXEC Add_BankManager 'Benjamin', '222 Maple Rd', '2023-09-10';
EXEC Add_BankManager 'Ava', '333 Willow Ln', '2023-10-01';
SELECT *
FROM BankManager
...
-- 5. Add_BankCustomer
EXEC Add_BankCustomer @BranchID = 1, @CustNameFirst  = 'Mike', @CustNameLast = 'Tyson', @CustAddress = '23 AVE NW Calgary, AB';
EXEC Add_BankCustomer @BranchID = 1, @CustNameFirst  = 'Mike', @CustNameLast = 'Wazowski', @CustAddress = 'Monsters Inc.';
EXEC Add_BankCustomer @BranchID = 2, @CustNameFirst  = 'Bill', @CustNameLast = 'Nye', @CustAddress = 'Somewhere in the Americas';
EXEC Add_BankCustomer @BranchID = 2, @CustNameFirst  = 'Alex', @CustNameLast = 'The Lion', @CustAddress = 'Madagascar, IDK, Zimbabwe';
SELECT *
FROM BankCustomer
